...
import com.page.utils.ProxyWebElementLocated;

public class PageInteraction {
	
	public HTMLElementManager HTML_ELEMENT_MGR;
	WebDriver driver;
	public static PageInteractionUtils utils;
	

	private PageInteraction(){
		
	}
	public PageInteraction(HTMLElementManager m, WebDriver driver) {
	...
	public HTMLElementManager getHtmlElementMgr() {
	...
	public By getByFromCSV(String elementName, String[] parameters){
	...
	public By getByFromCSV(String elementName, String parameter){
		return getByFromCSV( elementName, new String[] {parameter});
	}
	
	public By getByFromCSV(String elementName){
		HTMLElement element = HTML_ELEMENT_MGR.getElement(elementName);
		element.replaceLableKey(driver);
		return getBy(element.getByType(),element.getByValue());
	}
	 ...
	 * @param elementName
	 */
	public void findElementToClick(String elementName){
		String[] nullStrings = null;
		findElementToClick( elementName, nullStrings);
	}
	
	public void findElementToClick(String elementName, String parameter){
		findElementToClick( elementName, new String[] {parameter});
	}
	 ...
	 */
	public void findElementToClick(String elementName, String[] parameters){
		HTMLElement element = HTML_ELEMENT_MGR.getElement(elementName);
		element.replaceLableKey(driver);
		if (parameters!=null) element.setParameters(parameters);
		...
		switch(element.getElementType()){
			case PopUpButton:
				PageInteractionUtils.scrollWindowToElement(driver, by);
				PageInteractionUtils.clickButton(driver, by);
				PageInteractionUtils.switchToPopUpWin(driver);
				break;
			case Link:
				PageInteractionUtils.scrollWindowToElement(driver, by);
				PageInteractionUtils.clickLink(driver, by);
				break;
			case Button:
				PageInteractionUtils.scrollWindowToElement(driver, by);
				PageInteractionUtils.clickButton(driver, by);
			...
			case DropDownGearButton:
				...
				try{
					...
					try{
						...
						PageInteractionUtils.mouseOver(driver,Bylogoutbtn);
			...
			case HiddenElement:
				// Only use for gearbutton pop up layer menu items 
				PageInteractionUtils.clickHiddenElement(driver, by);
				break;
			case TextBox:
				PageInteractionUtils.scrollWindowToElement(driver, by);
				PageInteractionUtils.clickLink(driver, by);
	 ...
	 */
	public void findElementToSetValue( String elementName, String valueToSet){
		String[] nullStrings = null;
		findElementToSetValue( elementName, nullStrings,valueToSet);
	}
	
	public void findElementToSetValue( String elementName,  String parameter,String valueToSet){
		findElementToSetValue( elementName,  new String[] {parameter},valueToSet);
	}
	 ...
	 * @param parameters -parameters to replace the ? in the byValue
	 */
	public void findElementToSetValue( String elementName,  String[] parameters,String valueToSet){
		HTMLElement element = HTML_ELEMENT_MGR.getElement(elementName);
		element.replaceLableKey(driver);
		if (parameters!=null) element.setParameters(parameters);
		...
		switch(element.getElementType()){
			case TextBox:
				...
				PageInteractionUtils.fillin_textbox(driver, by, valueToSet);
				break;
			case DropDown:
				// passing value for selection
				PageInteractionUtils.select_selector(driver, by, valueToSet);
				break;
			case RadioBtnGrp:
				...
				PageInteractionUtils.checkRadioBtnGrpByValue(driver, by, valueToSet);
				break;
			case Checkbox:
				...
				if (valueToSet.equalsIgnoreCase("enable"))
					PageInteractionUtils.check_checkbox(driver, by);
				else
					PageInteractionUtils.uncheck_checkbox(driver, by);
				break;
			case DatePicker:
				PageInteractionUtils.dateSelect_Calandar(driver, valueToSet, by);
				break;
	 ...
	 */
	public boolean checkTextPresentInElement(String elementName, String valueToCheck){
		String[] nullStrings = null;
		return checkTextPresentInElement(elementName,  nullStrings,valueToCheck);
	}
	
	public boolean checkTextPresentInElement(String elementName,String parameter, String valueToCheck ){
		return checkTextPresentInElement( elementName, new String[] {parameter},  valueToCheck); 
	}
	 ...
	 * @return ture if element value match valueToCheck
	 */
	public boolean checkTextPresentInElement(String elementName, String[] parameters,String valueToCheck){
		HTMLElement element = HTML_ELEMENT_MGR.getElement(elementName);
		element.replaceLableKey(driver);		
		if (parameters!=null) element.setParameters(parameters);
		...
		Navigator.waitForAjax(driver, by);
		PageInteractionUtils.scrollWindowToElement(driver, by);
		String result =PageInteractionUtils.getText(driver, by).toLowerCase();
	 ...
	 */
	public boolean checkIfElementPresent(String elementName){
		String[] nullStrings = null;
		return checkIfElementPresent(elementName, nullStrings);
	}
	
	public boolean checkIfElementPresent(String elementName, String parameter){
		return checkIfElementPresent(elementName, new String[] {parameter});
	}
	 ...
	 * @return ture if element present
	 */
	public boolean checkIfElementPresent(String elementName, String[] parameters){
		HTMLElement element = HTML_ELEMENT_MGR.getElement(elementName);
		element.replaceLableKey(driver);
		if (parameters!=null) element.setParameters(parameters);
		...
		By by;
		by = getBy(element.getByType(),element.getByValue());
		return PageInteractionUtils.isElementPresent(driver, by);
	}
	 ...
	 * @return ture if element present
	 */
	public void checkElementShouldPresent(String elementName){
		String[] nullStrings = null;
		checkElementShouldPresent(elementName, nullStrings);
	}
	
	public void checkElementShouldPresent(String elementName, String parameter){
		checkElementShouldPresent(elementName, new String[] {parameter});
	}
	 ...
	 * @param parameters -parameters to replace the ? in the byValue
	 */
	public void checkElementShouldPresent(String elementName, String[] parameters){
		HTMLElement element = HTML_ELEMENT_MGR.getElement(elementName);
		element.replaceLableKey(driver);
		if (parameters!=null) element.setParameters(parameters);
		...
		Navigator.waitForAjax(driver, by);
		PageInteractionUtils.scrollWindowToElement(driver, by);
		JUnitAssert.assertTrue(PageInteractionUtils.elementShouldPresent(driver, by), by.toString() +" shuold be found");
	}
	 ...
	 * @return ture if element present
	 */
	public void checkElementShouldNotPresent(String elementName){
		String[] nullStrings = null;
		checkElementShouldNotPresent(elementName, nullStrings);
	}
	
	public void checkElementShouldNotPresent(String elementName, String parameter){
		checkElementShouldNotPresent( elementName, new String[] {parameter});
	}
	 ...
	 * @param parameters -parameters to replace the ? in the byValue
	 */
	public void checkElementShouldNotPresent(String elementName, String[] parameters){
		HTMLElement element = HTML_ELEMENT_MGR.getElement(elementName);
		element.replaceLableKey(driver);
		if (parameters!=null) element.setParameters(parameters);
		...
		JUnitAssert.assertTrue(!PageInteractionUtils.isElementPresent(driver, by), by.toString() +" should not found");
	}
	
	public static class PageInteractionUtils {
		...
		public static void setVisitedWinsMap(HashMap<WebDriver, ArrayList<String>> visitedWinsMap) {
			PageInteractionUtils.visitedWinsMap = visitedWinsMap;
		}



		// Suppress default constructor for noninstantiability
		private PageInteractionUtils() {
...
//		}
		...
		public static boolean refreshingAndCheckTextPresentedInPage(
			...
			while (!textPresented && counter < loop_max) {
				...
				textPresented = PageInteractionUtils.textPresentInPage(driver,
						textToFound);
				;
				counter++;
			}
		...
		public static void switchToPreviousTab(WebDriver driver) {
			PageInteractionUtils.switchToParentWin(driver);
		}
...
//				loopCounter = loopCounter + 1;
		...
		public static void closeAllWins(WebDriver driver) {
			...
			PageInteractionUtils.clearVisitedWins(driver);
		}
		...
		public static void closeAllPopUpWins(WebDriver driver) {
			...
			if (visitedWins.size() > 0) {
				...
				PageInteractionUtils.switchToBaseWin(driver);
			}
		}
		...
		public static void checkMulti_InTree(WebDriver driver, String[] keywords) {
			...
			for (String keyword : keywords) {
				PageInteractionUtils.selectCheckBox_InTree(driver, keyword);
			}
		...
		private static void selectCheckBox_InTree(WebDriver driver,
			...
			if (!keyword.equals("")) {
				...
				if (!keyword.contains("/")) {
					...
					PageInteractionUtils.selectCheckBox_InTree(driver, str);
				}
			}
		}
		...
		public static void dateSelect_Calandar(WebDriver driver, String dateString,
			...
			PageInteractionUtils.dateSelect_Calandar(driver, dateString, by);
		}
		/**
		...
		public static void dateSelect_Calandar(WebDriver driver, String dateString, By calendarBy) {
			...
			if (!dateString.equals("")) {
				...
				if (size == 1) {
					PageInteractionUtils.select_selector(driver, by,  Integer.valueOf(year).toString());
				} 

				by = By.xpath("//select[@data-handler='selectMonth']");
				size = getHowManyByPresntInPage(driver, by, false);
				if (size == 1) {
					PageInteractionUtils.select_selector(driver, by, month - 1); //
				}
				

				by = By.linkText(Integer.valueOf(day).toString());
				size = PageInteractionUtils.getHowManyByPresntInPage(driver, by, false);
				if (size == 0) {
		...
		public static synchronized void mouseOver(WebDriver driver, By by) {
			...
			Navigator.waitForAjax(driver, by);
			PageInteractionUtils.highlightElement(driver, by);
		...
		public static int getTableRowCount(WebDriver driver, By by_rows) {
			...
			if (size >= 1) {
				PageInteractionUtils.highlightElement(driver, by_rows);
			}
			return size;
		}
		...
		public static int getTableColumnCount(WebDriver driver, By by_columns) {
			...
			if (size >= 1) {
				PageInteractionUtils.highlightElement(driver, by_columns);
			}
			return size;
		}
		...
		public static void cancelAlertIfPresent(WebDriver driver){
			...
			boolean exist = PageInteractionUtils.isAlertPresent(driver);
			if (exist) {
		...
		public static void waitAlertAndAccept(WebDriver driver) {
			...
			do {
				...
				Navigator.explicitWait(3000);
				driver.navigate().refresh();
				flag = PageInteractionUtils.isAlertPresent(driver);
				counter++;
			} while (!flag && counter < loop_max);

			if (flag) {
				PageInteractionUtils.acceptAlert(driver);
			}
		}
		...
		public static void checkAdobeFlashResults(WebDriver driver, By srcBy,
			...
			String temp = URLUtils.decodeURL(PageInteractionUtils.getElementAttribute(driver,
					srcBy, "value"));
			...
			PageInteractionUtils.openURL(driver, url);

			// 2. Check actual result
			By by = By.xpath("//set[@name='" + key + "']");
			String actualStatistic = PageInteractionUtils.getElementAttribute(driver, by,
					"value");
		...
		private static HashMap<String, Integer> getLevels(WebDriver driver, String[] keys) {
			...
			for (String key : keys) {
				...
				String key_temp = PageInteractionUtils.getElementAttribute(driver, by, "name");
				if (key_temp.equals(key)) {
					level = 1;
				} else {
					by = By.xpath("//categories/category/category");
					key_temp = PageInteractionUtils.getElementAttribute(driver, by, "name");
					if (key_temp.equals(key)) {
						level = 2;
					} else {
						...
						if (key_temp.equals(key)) {
							...
							key_temp = PageInteractionUtils.getElementAttribute(driver, by,
									"name");
							if (key_temp.equals(key)) {
								level = 4;
							}
